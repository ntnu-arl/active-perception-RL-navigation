...
from src.config.env.env_active_camera_with_30obstacles import EnvActiveCameraWith30ObstaclesCfg
from src.config.robot.active_camera_quad_config import LMF2ActiveCameraCfg

env_config_registry.register("env_active_camera_with_obstacles", EnvActiveCameraWith30ObstaclesCfg)
