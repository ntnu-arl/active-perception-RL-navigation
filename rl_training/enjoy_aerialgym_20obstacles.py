...
from src.config.env.env_active_camera_with_20obstacles import EnvActiveCameraWith20ObstaclesCfg
from src.config.robot.active_camera_quad_config import LMF2ActiveCameraCfg

env_config_registry.register("env_active_camera_with_obstacles", EnvActiveCameraWith20ObstaclesCfg)
