from src.config.assets.env_object_config import (
    panel_asset_params,
    thin_asset_params,
    tree_asset_params,
    thirty_object_asset_params,
    tile_asset_params,
)
from src.config.assets.env_object_config import (
    left_wall,
...
class EnvActiveCameraWith30ObstaclesCfg:
    class env:
        ...
        use_warp = True
        lower_bound_min = [-6.0, -4.0, -3.0]  # lower bound for the environment space
        lower_bound_max = [-5.0, -2.5, -2.0]  # lower bound for the environment space
        upper_bound_min = [5.0, 2.5, 2.0]  # upper bound for the environment space
        upper_bound_max = [6.0, 4.0, 3.0]  # upper bound for the environment space
    ...
    class env_config:
        ...
        asset_type_to_dict_map = {
            ...
            "objects": thirty_object_asset_params,
            "left_wall": left_wall,
