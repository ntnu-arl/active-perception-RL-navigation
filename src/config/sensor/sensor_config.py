...
class DepthCameraConfig():
    ...
    world_map_grid_size_x = 121 # voxel size: 12m / 0.25m
    world_map_grid_size_y = 81 # voxel size: 8m  / 0.25m
    world_map_grid_size_z = 61 # voxel size: 6m  / 0.25m
    ...
    # min_translation = [0.25, -0.03, -0.02]
    # max_translation = [0.3, 0.03, 0.02]
    min_euler_rotation_deg = [-5.0, -5.0, -5.0]
    max_euler_rotation_deg = [5.0, 5.0, 5.0]
    # camera motion limitations
    min_pitch_rad = -np.pi / 2.0  # minimum pitch angle in radians
    max_pitch_rad = np.pi / 2.0  # maximum pitch angle in radians
    deg2rad = np.pi / 180.0
