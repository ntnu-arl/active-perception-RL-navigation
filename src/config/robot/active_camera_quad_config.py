...
from src import ACTIVE_CAMERA_NAVIGATION_DIRECTORY
...
class LMF2ActiveCameraCfg:
    ...
    class sensor_config:
        enable_camera = True
        camera_config = DepthCameraConfig
    ...
    class robot_asset:
        asset_folder = f"{ACTIVE_CAMERA_NAVIGATION_DIRECTORY}/src/robot"
        file = "model.urdf"
